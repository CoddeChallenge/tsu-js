...
O TSU JS é uma solução open source desenvolvida para ajudar os Funcionários Públicos e agentes do estado a simular o seu salário com base na Tabela Salarial Única.

# COMO CONTRIBUIR
De domínio básico de Javascript, Html ou CSS ?? Faça um clone do repositório e contribua.
